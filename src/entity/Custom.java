...
public class Custom implements SuperEntity {
    ...
    public Custom(String customerId, String firstName, String lastName, String nic, String gender, Date dob, String address, String mobileNumber, String drivingLicense, double amount, double balance, int dates, int remainingDates) {
